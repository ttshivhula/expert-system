...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/06/06 06:04:09 by qmanamel          #+#    #+#              #
#    Updated: 2017/06/09 17:01:38 by qmanamel         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c \
	  ...
	  ft_strdel.c ft_strmap.c ft_strequ.c ft_strnequ.c ft_strjoin.c ft_lstnew.c \
	  ft_strsub.c ft_strjoin.c ft_lstadd.c ft_strmapi.c ft_putnbr.c \
	  ft_lstdelone.c ft_itoa.c ft_lstiter.c ft_strsplit.c ft_strtrim.c ft_lstmap.c\
	  ft_splitcounter.c ft_lstdel.c \
